...
public class JsonParseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.e("JsonParser Exaple", "unexpected JSON exception", ex);
        }
    }
    private String getListData(){
        String jsonStr = "{\"users\" :["+
                "{\"name\":\"Monkey D. Luffy\",\"designation\":\"Leader\",\"location\":\"EastBlue\"}" +
                "{\"name\":\"Roronoa Zoro\",\"designation\":\"Vice Leader\",\"location\":\"EastBlue\"}" +
                "{\"name\":\"Nami\",\"designation\":\"Lea\",\"location\":\"EastBlue\"}]}";
        return jsonStr;
    }
}
